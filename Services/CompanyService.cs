...
namespace StudentInternshipManagement.Services
{
    public class CompanyService
    {
        ...
        public async Task<Company> AddCompanyAsync(Company company)
        {
            ...
            var existingCompany = await _companyRepo.GetByNameAsync(company.Name);
        ...
        public async Task<List<Company>> SearchCompaniesAsync(string keyword)
        {
            return await _companyRepo.SearchAsync(keyword);
        }
    }
}